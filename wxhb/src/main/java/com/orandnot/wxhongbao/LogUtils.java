...
public final class LogUtils {
	...
	private static String TAG = "wxhb";
	...
	public static void saveErrorLog(String msg) {
		...
		try {
			...
			if(storageState.equals(Environment.MEDIA_MOUNTED)){
				savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/1wxhb/log/";
	...
	public static void uploadErrorLog() {
		new Thread(new Runnable() {
			@Override
			public void run() {
				String log = Environment.getExternalStorageDirectory().getAbsolutePath() + "/1wxhb/log/info.txt";
